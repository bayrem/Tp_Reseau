...
//LSP
//LSP1
        LSP1.SetGW_source("GW2");
        LSP1.Setvoisin("N2");
        LSP1.Setcout(0);
        LSP.add(LSP1);
//LSP2
        LSP2.SetGW_source("GW2");
        LSP2.Setvoisin("GW1");
        LSP2.Setcout(7);
        LSP.add(LSP2);
//LSP3
        LSP3.SetGW_source("GW2");
        LSP3.Setvoisin("GW3");
        LSP3.Setcout(10);
        LSP.add(LSP3);
//****************************************************************
...
//envoi de la LSP
            Socket socketClient = new Socket("127.0.0.1", 14422);
            ...
            ServerSocket socketBienvenue=new ServerSocket(14022);
            ...
            for (int j=0;j<LSDB.size();j++) {
              System.out.println(LSDB.get(j).GetGW_source());
              System.out.println(LSDB.get(j).Getvoisin());
              System.out.println(LSDB.get(j).Getcout());
          }
