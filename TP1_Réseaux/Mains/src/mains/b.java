...
public class b {
 ...
 r1.SetDest("D");r1.SetWH("D");r1.SetCont(1);tableroutage.add(r1);
 Routage r2= new Routage();
 r2.SetDest("E");r2.SetWH("D");r2.SetCont(2);tableroutage.add(r2);
 Routage r3= new Routage();
 r3.SetDest("C");r3.SetWH("D");r3.SetCont(3); tableroutage.add(r3);
 Routage r4= new Routage();
 r4.SetDest("A");r4.SetWH("D"); r4.SetCont(4); tableroutage.add(r4);
 Routage r5= new Routage();
 r5.SetDest("A");r5.SetWH("A");r5.SetCont(1);tableroutage.add(r5);
 Routage r6= new Routage();
 r6.SetDest("C");r6.SetWH("A");r6.SetCont(2);tableroutage.add(r6);
 Routage r7= new Routage();
 r7.SetDest("E");r7.SetWH("3");r7.SetCont(3);tableroutage.add(r7);
 Routage r8= new Routage();
 r8.SetDest("D");r8.SetWH("A");r8.SetCont(4);tableroutage.add(r8);
    Scanner sc = new Scanner(System.in);
    Scanner dt = new Scanner(System.in);
    Scanner des = new Scanner(System.in);


    p.SetSrc("B");String[] b = {"Envoyer un mesg", "mettre le srveur en cout","Annuler"};
		...
		String choi = (String)jop.showInputDialog(null,
										...
										b,
										b[2]);
		jop2.showMessageDialog(null, "Votre choix est " + choi, "Serveur B !", JOptionPane.INFORMATION_MESSAGE);


    if (choi.equals(b[0])){
        JOptionPane jop5 = new JOptionPane(), jop6 = new JOptionPane();
        String msg = jop5.showInputDialog(null, "Veuillez entrer votre msg !", "Serveur B !", JOptionPane.QUESTION_MESSAGE);
	jop6.showMessageDialog(null, "Votre msg est " + msg, "Serveur B !", JOptionPane.INFORMATION_MESSAGE);
        p.SetData(msg) ;
		...
		String dest = (String)jop3.showInputDialog(null,
										...
										d,
										d[2]);
		jop4.showMessageDialog(null, "Votre destination est " + dest, "Serveur B !", JOptionPane.INFORMATION_MESSAGE);
        p.SetDest(dest);
...
sort.writeObject(p);
    ...
    // Créer un socket d'écoute sur le port 14406
    ServerSocket socketBienvenue = new ServerSocket(14406);
    System.out.println("Port n°" +socketBienvenue.getLocalPort()+"du serveur B est à l'écoute...");

    while(true) {
        //Attendre la connexion d'un client
        Socket socketConnexion= socketBienvenue.accept();

        //Crأ©er le flux d'entree attachأ© au socket
    ...
    //Lire la chaine de caracteres depuis le socket
        ...
        System.out.println("la destination est:" + p.GetDest());
         ...
         catch(ClassNotFoundException paquet){
          System.out.println("> SERVER : Le type de l'objet recu est inconnu!" );
         }
        if (p.GetDest().compareTo("B")!=0){
        //choisir le prochain saut:
