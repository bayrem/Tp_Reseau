...
public class e {
 ...
 r1.SetDest("C");r1.SetWH("C");r1.SetCont(1);tableroutage.add(r1);
 Routage r2= new Routage();
 r2.SetDest("A");r2.SetWH("C");r2.SetCont(2);tableroutage.add(r2);
 Routage r3= new Routage();
 r3.SetDest("B");r3.SetWH("C");r3.SetCont(3); tableroutage.add(r3);
 Routage r4= new Routage();
 r4.SetDest("D");r4.SetWH("C"); r4.SetCont(4); tableroutage.add(r4);
 Routage r5= new Routage();
 r5.SetDest("D");r5.SetWH("D");r5.SetCont(1);tableroutage.add(r5);
 Routage r6= new Routage();
 r6.SetDest("B");r6.SetWH("D");r6.SetCont(2);tableroutage.add(r6);
 Routage r7= new Routage();
 r7.SetDest("A");r7.SetWH("D");r7.SetCont(3);tableroutage.add(r7);
 Routage r8= new Routage();
 r8.SetDest("C");r8.SetWH("D");r8.SetCont(4);tableroutage.add(r8);
  ...
  String[] b = {"Envoyer un mesg", "mettre le srveur en cout","Annuler"};
		...
		String choi = (String)jop.showInputDialog(null,
										...
										b,
										b[2]);
		jop2.showMessageDialog(null, "Votre choix est " + choi, "Serveur E !", JOptionPane.INFORMATION_MESSAGE);


    if (choi.equals(b[0])){
        JOptionPane jop5 = new JOptionPane(), jop6 = new JOptionPane();
        String msg = jop5.showInputDialog(null, "Veuillez entrer votre msg !", "Serveur E !", JOptionPane.QUESTION_MESSAGE);
	jop6.showMessageDialog(null, "Votre msg est " + msg, "Serveur E !", JOptionPane.INFORMATION_MESSAGE);
        p.SetData(msg) ;
		...
		String dest = (String)jop3.showInputDialog(null,
										...
										d,
										d[2]);
		jop4.showMessageDialog(null, "Votre destination est " + dest, "Serveur E !", JOptionPane.INFORMATION_MESSAGE);
        p.SetDest(dest);
...
sort.writeObject(p);
    ...
    // Créer un socket d'écoute sur le port 14409
    ServerSocket socketBienvenue = new ServerSocket(14409);
    System.out.println("Port n°" +socketBienvenue.getLocalPort()+"du serveur E est à l'écoute...");
